...
def clean_data_logic(df):
    ...
    valid_rows_mask = valid_stress_biosensor & valid_stress_self
...
def process_and_clean_data(file_path):
    ...
    # Remove subjects with systolic blood pressure lower than diastolic blood pressure (biologically impossible)
    ...
    print(f"Removed {len(df_removed)} outliers based on biologically impossible blood pressure values.")
    print(f"{(df_removed)}")
